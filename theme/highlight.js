...
;hljs.registerLanguage("css",e)})();/*! `hy` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("powershell",e)})();/*! `scheme` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
const t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n="(-|\\+)?\\d+([./]\\d+)?",r={
$pattern:t,
...
;hljs.registerLanguage("stylus",e)})();/*! `x86asm` grammar compiled for Highlight.js 11.9.0 */
